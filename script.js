document.addEventListener('DOMContentLoaded', () => {
    ...
    const petsPool = {
        common: [
            { name: 'Котик', image: 'images/cat.png' },
            { name: 'Зайчик', image: 'images/rabbit.png' }
        ],
        rare: [
            { name: 'Собачка', image: 'images/dog.png' },
            { name: 'Птичка', image: 'images/bird.png' }
        ],
        legendary: [
            { name: 'Дракончик', image: 'images/dragon.png' }
        ]
    };
